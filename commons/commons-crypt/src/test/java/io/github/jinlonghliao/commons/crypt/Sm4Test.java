...
public class Sm4Test {
    ...
    @Test
    public void sm4Test1() throws Exception {
        encryptUtils = new SymmetryEncryptUtils(SymmetryEncryptUtils.SM4, HEX_KEY);
        encode = encryptUtils.encode(plainText);
    }

    @Test
    public void sm4Test2() throws Exception {
        encryptUtils = new SymmetryEncryptUtils(SymmetryEncryptUtils.SM4_CBP, HEX_KEY);
        encode = encryptUtils.encode(plainText);
    }
