 ...
 * @since 2.2.0
 */
public class SwaggerMappingSupport extends MappingSupport {
    ...
    public SwaggerMappingSupport(ServletContext servletContext, String urlPatternMapping) throws IOException {
