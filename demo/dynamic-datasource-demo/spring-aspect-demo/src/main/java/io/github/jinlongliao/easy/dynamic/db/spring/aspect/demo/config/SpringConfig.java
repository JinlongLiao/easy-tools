...
import io.github.jinlongliao.easy.dynamic.db.spring.aspect.demo.datasource.MybatisConfig;
...
import io.github.jinlongliao.easy.dynamic.db.spring.config.DynamicDataSource;
import io.github.jinlongliao.easy.dynamic.db.spring.config.DynamicDataSources;
...
@MapperScan(basePackages = {
        "io.github.jinlongliao.easy.dynamic.db.spring.aspect.demo.mybatis.dao"
})
@Configuration
@EnableWebMvc
@EnableAspectJAutoProxy(proxyTargetClass = true)
@ComponentScan(basePackages = {"io.github.jinlongliao.easy.dynamic.db.spring.aspect.demo"},
        excludeFilters = {
                @ComponentScan.Filter(type = FilterType.ANNOTATION, value = EnableWebMvc.class)})
@DynamicDataSources({
        @DynamicDataSource(pointCut = "execution(* io.github.jinlongliao.easy.dynamic.db.spring.aspect.demo.mybatis.service.impl.TbAdminRoleServiceImpl.*(..))", dbKey = "db1")
        , @DynamicDataSource(pointCut = "execution(* io.github.jinlongliao.easy.dynamic.db.spring.aspect.demo.mybatis.service.impl.UserServiceImpl.*(..))", dbKey = "db2")
})
